    ...
    return (
      <div>
        ...
        <Navbar color="light" light expand="md" className={css(styles.black)}>
          <NavbarBrand href="/" className={css(styles.logo)}>
            FlippingTheScales
          </NavbarBrand>
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
              {localStorage.getItem('tokenExp') > new Date().getTime() ? (
                <React.Fragment>
                  <NavItem>
                    <NavLink href="/dashboard" className={css(styles.font)}>
                      Dashboard
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="/createComp" className={css(styles.font)}>
                      Create Competition
                    </NavLink>
                  </NavItem>
                  <NavItem className={css(styles.hiddenItem)}>
                    <NavLink href="/addcompbyid" className={css(styles.font)}>
                      Add Competition By ID
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="/blog/" className={css(styles.font)}>
                      Blog
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="#" className={css(styles.font)} onClick={this.logoutFunc}>
                      Log-Out
                    </NavLink>
                  </NavItem>
                </React.Fragment>
                ...
                <React.Fragment>
                  <NavItem>
                    <NavLink href="/register" className={css(styles.font)}>
                      Sign-Up
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink href="#" className={css(styles.font)} onClick={this.loginOpen}>
                      Sign-In
                    </NavLink>
                  </NavItem>
                  <NavItem>
