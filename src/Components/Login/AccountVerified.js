...
class Verified extends Component {
  ...
  componentDidMount() {
    ...
    } else if (urlParam === '?error_code_1') {
      this.setState({
        errorMsg: 'There was a problem with your User ID, Please reclick the registration link in your email.',
      });
    } else if (urlParam === '?error_code_2') {
      this.setState({
        errorMsg:
          'There was a problem with your verification token, Please reclick the registration link in your email.',
      });
    }
  }
  ...
  render() {
    let login = () => {
      ...
      axios
        .post(Config.backendRootURL + '/signin', {
          username: username,
          password: password,
        })
    ...
    return (
      <div className={css(styles.RegisterSection)}>
        ...
        <input className={css(styles.input)} type="text" id="username1" /> <br /> <br />
        <p className={css(styles.text)}> Password </p>
        <input className={css(styles.input)} type="password" id="password1" /> <br /> <br />
        <Container>
          <Row>
            <Col
              xs={{
